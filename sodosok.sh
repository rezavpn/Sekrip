...
cd /usr/bin
wget -O add-ss "https://github.com/rezavpn/Sekrip/blob/main/add-ss.sh"
wget -O del-ss "https://github.com/rezavpn/Sekrip/blob/main/del-ss.sh"
wget -O cek-ss "https://github.com/rezavpn/Sekrip/blob/main/cek-ss.sh"
wget -O renew-ss "https://github.com/rezavpn/Sekrip/blob/main/renew-ss.sh"
chmod +x add-ss
chmod +x del-ss
chmod +x cek-ss
chmod +x renew-ss
